...
})({"f2gas":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "423f565d69a099cb";
"use strict";
...
},{}],"4hjQU":[function(require,module,exports) {
/**
                ...
                this.elements = [
                    ...
                    new function() {
                        ...
                        this.click = function() {
                            ...
                            if (!webix.rules.isEmail(order.email)) //...error email
                            webix.message("Enter a valid email address", "danger");
                            else if (!webix.rules.isNumber(order.phone)) //...error phone
                            webix.message("Enter a valid phone number", "danger");
                            else {
                                //...confirm submission
                                webix.message("your order has been submitted...");
                                emailjs.send('Orders', 'template_orders', order).then(function(response) {
...
},{}]},["f2gas","4hjQU"], "4hjQU", "parcelRequire94c2")

//# sourceMappingURL=orders.69a099cb.js.map
